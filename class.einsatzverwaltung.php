...
class Einsatzverwaltung {
    ...
    public function display_missions() {
        ...
        $years = $this->dbHandler->get_mission_years();
        ...
        if ( !isset( $_POST['einsatzjahr'] ) ) {
            $missions = $this->dbHandler->get_missions_by_year( CURRENT_YEAR );
        }
        else {
            $missions = $this->dbHandler->get_missions_by_year( $_POST['einsatzjahr'] );
        }
...
EOF;
    ...
    public function postinfo() {
        ...
        $mission = $this->dbHandler->load_mission_by_post_id( $post->ID );
        $vehicles = $this->dbHandler->load_vehicles_by_mission_id( $mission->id );
